...
class DualPerceptron:
    def __init__(self,dataSet,linearKernel=True,learningRate=0.1,epochs=100,kFold=10):
    ...
    def GetAccuracy(self, trainDataSet, testDataSet, weights):
    ...
    def validate(self):
        ...
        for trainIndex, testIndex in self.kf.split(self.dataSet):
            ...
            accuracy = self.GetAccuracy(trainDataSet, testDataSet, weights)
