...
class SVM:
    ...
    def SVClinear(self):
        ...
        print(
            "Fold\tC\tTrained Accuracy\tTrained Precision\tTrained Recall\tTested Accuracy\tTested Precision\tTested Recall")
        for trainIndex, testIndex in self.kf.split(self.dataSet):
            ...
            nestedTrainDataSets = []
            nestedTestDataSets = []
            for nestedTrainIndex, nestedTestIndex in self.mf.split(trainDataSet):
    ...
    def SVCrbf(self):
        ...
        print(
            "Fold\tC\tGamma\tTrained Accuracy\tTrained Precision\tTrained Recall\tTested Accuracy\tTested Precision\tTested Recall"
        )
        for trainIndex, testIndex in self.kf.split(self.dataSet):
            trainDataSet = self.dataSet.iloc[trainIndex]
            xTrain = trainDataSet.iloc[:, :-1]
